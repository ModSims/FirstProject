...
int main(int argc, char* argv[]) {
    argparse::ArgumentParser program("karman_vortex_street_2d");
    ...
    program.add_argument("-z", "--t_end").help("t_end").default_value(50.0).action([](const std::string& value) { return std::stod(value); });
    ...
    program.add_argument("-m", "--itermax").help("itermax").default_value(500).action([](const std::string& value) { return std::stoi(value); });
    ...
    KarmanVortexStreet2D sim = KarmanVortexStreet2D(
